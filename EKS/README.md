...
aws eks --region us-east-1 create-cluster --name demo --role-arn arn:aws:iam::866824485776:role/eksClusterRole --resources-vpc-config subnetIds=subnet-002a82762e54dded7,subnet-085b62301b5beeeb8,subnet-00eb1dec7f31200f4,securityGroupIds=sg-05c8a8bb6449ec33c
```
...
```
Node image id - ami-0c5b63ec54dd3fc38
